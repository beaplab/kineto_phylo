...
hits <- fread("subset_both_batches.csv") 
...
# "_blastout_decontam_refG_out6.txt" can be obtained from decontamination BLAST process described in MASTER_commands_V2.sh
