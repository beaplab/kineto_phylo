...
# 
# use CvarSetup;
# CvarSetup::uselib('CvarTools::GetOptions');
# 
# my $HELP_OPTION = 'help';
# my $FILE_OPTION = 'file';
...
# 		      $FILE_OPTION => '=s');
# my %args = 
#     &CvarTools::GetOptions::get_options('options' => \%OPTION_TYPES);
#
# if ($args{$HELP_OPTION})
# {
...
#
# Written Tuesday, December 19, 2000, Dan Richter
#
# Updated to remove dependence on CvarSetup
# Thursday, October 7, 2004, Dan Richter
###
